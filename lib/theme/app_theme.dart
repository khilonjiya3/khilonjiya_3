...
class AppTheme {
  ...
  static const Color textSecondaryDark = Color(0xFF9CA3AF); // Medium light text
  ...
  static const Color shadowLight = Color(0x0A000000); // Maximum 0.1 opacity
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      primaryContainer: primaryLight.withValues(alpha: (26/255.0 * 255).toDouble()),
      onPrimaryContainer: primaryLight,
      secondary: secondaryLight,
      onSecondary: Colors.white,
      secondaryContainer: secondaryLight.withValues(alpha: (26/255.0 * 255).toDouble()),
      onSecondaryContainer: secondaryLight,
      tertiary: accentLight,
      onTertiary: Colors.white,
      tertiaryContainer: accentLight.withValues(alpha: (26/255.0 * 255).toDouble()),
      onTertiaryContainer: accentLight,
      error: errorLight,
      onError: Colors.white,
      errorContainer: errorLight.withValues(alpha: (26/255.0 * 255).toDouble()),
    ...
    cardTheme: CardThemeData(
      ...
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(12.0), // 12px for content cards
      ),
    ),
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder(
          borderRadius:
              BorderRadius.circular(8.0), // 8px for interactive elements
        ),
 ...
 /// Helper method to get data/monospace text style
  static TextStyle getDataTextStyle({
    ...
    return GoogleFonts.robotoMono(
      // Using Roboto Mono as SF Mono alternative
      fontSize: fontSize,
  ...
  /// Helper method to get outline color based on theme
  static Color getOutlineColor(bool isLight) {
    return isLight ? outlineLight : outlineDark;
  }
